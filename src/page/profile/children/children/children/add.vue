 <template>
  <div class="rating_page">
        <section class="adddetail">
        	<form action="" v-on:submit.prevent>
        		...
        		<section class="addbutton">
        			<button @click="submitAddress()">保存</button>
        		</section>
        ...
        <alert-tip :showAlertTip="showAlertTip" :alertText='`<p>确定要删除该地址吗！</p>`' :type="1" :func="deleteAddress()" v-show="showAlertTip"></alert-tip>
    </div>
</template>
    ...
    getRegionsList(0).then(res => {
      ...
      var picker = new AjaxPicker({
        ...
        success: function(arr) {
          ...
          that.address.districtId = picker.result3.id;
